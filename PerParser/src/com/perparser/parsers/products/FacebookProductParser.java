package com.perparser.parsers.products;

import com.perparser.parsers.BaseParser;
import com.perparser.parsers.products.model.FacebookProduct;
...
public class FacebookProductParser extends BaseParser {
	...
	public JSONObject parseToJson(InputStream stream, String countryCode) throws IOException {		
		...
		while ((line = bufferedReader.readLine()) != null) {
			FacebookProduct fbp = FacebookProduct.build(line,countryCode);
			if (fbp != null){
